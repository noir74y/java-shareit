...
public class RequestControllerGateway {
    ...
    @PostMapping
    public ResponseEntity<Object> create(@RequestHeader(HEADER_USER_ID) Integer requestorId,
    ...
    @GetMapping
    public ResponseEntity<Object> findAllByUser(@RequestHeader(HEADER_USER_ID) Integer requestorId) {
        log.info("requestorId={}, GET /requests/", requestorId);
        return requestClient.findAllByUser(requestorId);
    }

    @GetMapping("/all")
    public ResponseEntity<Object> findAllByOthers(@RequestHeader(HEADER_USER_ID) Integer requestorId,
    ...
    public ResponseEntity<Object> findById(@RequestHeader(HEADER_USER_ID) Integer requestorId,
